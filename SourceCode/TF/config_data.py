"""
Repurposed TF Example to be example classifier for Optical Network-On-Chip
Configurational Classifier
...
#SPECIES = ['VeryGood', 'Good', 'Average', 'Bad', 'VeryBad']
SPECIES = ['Good', 'Average', 'Bad']
