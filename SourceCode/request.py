...
class request:
    ...
    def __init__(self, theListOfInfo):
        ...
        self.volume         = theListOfInfo[3] * config.Vol #Volume of request 
        self.volumeTrack    = theListOfInfo[3] * config.Vol #Volume of request
        volumeTrack         = theListOfInfo[3] * config.Vol #Volume of request
